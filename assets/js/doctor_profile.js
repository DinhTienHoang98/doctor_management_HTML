...
function init() {
    ...
    console.log("dad" + currentDoctor);
    if (currentDoctor == null) {
        window.location.href = "search.html"
    }
    getById(currentDoctor);
}
...
function getById(id) {
    ...
    $.ajax({
        ...
        success: function (doctor) {
            $("#doctor-profile").html(renderDoctorHtml(doctor));
        },
...
function renderDoctorHtml(doctor) {
    return `
<div class="container">
        ...
        <div class="doctor-widget">
            <div class="doc-info-left">
                ...
                <div class="doc-info-cont">
                    ...
                    <p class="doc-speciality">${doctor.workplace}</p>
                    ${getSpecializationIconFromCode(doctor.specialization_description)}${doctor.specialization_description != null ? doctor.specialization_description : `<i><-- Chưa cập nhập thông tin --></i>`}</h5>
                            ...
                            <div class="clinic-content">
                                ...
                                <div class="clinic-details mb-0">
                                    <h5 class="clinic-direction"> <i class="fas fa-map-marker-alt"></i>
                                        2286 Sundown Lane, Austin, Texas 78749, USA <br><a
